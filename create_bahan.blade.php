...
<div class="container">
    ...
    <a href="/atur_bahan" class="btn btn-secondary">Kembali</a>
    <br/>
    <!-- Form untuk menambahkan produk baru -->
    <form action="/insert_bahan" method="POST" enctype="multipart/form-data">
        <!-- Token CSRF untuk keamanan -->
        @csrf
        <!-- Input untuk kode produk, hanya baca karena sudah di-generate otomatis -->
        <div class="form-group">
            <label for="kode_produk">Kode Bahan:</label>
            <input type="text" class="form-control" id="kode_produk" name="kode_bahan" value="{{ $kodeBahan }}" readonly>
        </div>
